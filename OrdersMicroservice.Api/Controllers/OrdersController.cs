...
using OrdersMicroservice.Api.Models;
...
namespace OrdersProcessingService.Api.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<IEnumerable<Order>> GetAll()
        {
            ...
            return mapper.Map<IEnumerable<OrdersMicroservice.Core.Domain.Order>, IEnumerable<Order>>(result);
        }
        ...
        public async Task<ActionResult<Order>> Get(Guid orderId)
        {
            ...
            var response = mapper.Map<OrdersMicroservice.Core.Domain.Order, Order>(result);
        ...
        {
            var order = new OrdersMicroservice.Core.Domain.Order()
            {
                Id = orderId,
        ...
        public async Task<IEnumerable<OrdersByUser>> GetOrdersByUser()
        {
            ...
            return mapper.Map<IEnumerable<OrdersMicroservice.Core.Domain.OrdersByUser>, IEnumerable<OrdersByUser>>(result);
        }
    }
}